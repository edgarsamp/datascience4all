...
setwd("/home/vinicius/Dropbox/unb/data_science/relatorio2")

#Ler o arquivo profile
profile <- jsonlite::fromJSON("cic_profile.json")
public <- jsonlite::fromJSON("cic_publication.json")
advise <- jsonlite::fromJSON("cic_advise.json")
