...
cic_public <- jsonlite::fromJSON("cic_publication.json")
...
Através da plataforma eLattes, foi feito o download dos arquivos json gerados, contendo os dados brutos que serão analisados. Serão analisados os arquivos *advise.json*, *profile.json* e *publication.json*.
