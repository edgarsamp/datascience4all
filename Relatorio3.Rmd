...
![Fases CRISP-DM](./images/CRISPDM.png){width=350px} 
...
Percebe-se que a área de atuação com maior recorrência é a *Ciência da Computação* o que faz todo sentido já que se trata do programa de Ciência da Computação.
Percebe-se também uma grande porcentagem em relação a área *Matemática* o que pode indicar que no programa de Matemática existem grandes chances de a área de Ciência da Computação ter uma porcentagem expressiva também.
...
Ao analisar a categoria outras orientações percebe-se que sempre possui uma quantidade elevada de publicações, isso se dá ao fato dela ser composta por trabalhos de conclusão de curso e iniciação científica de estudantes de graduação. Nela também está incluso orientações de outras naturezas que não são especificadas currículo dos orientadores observados/analisados.
...
Diversas análises pontuais e gerais puderam ser levantadas e como oportunidade de trabalhos futuros os que mais chamam a atenção é o aprofundamento nas relações entre os 3 programas analisados, a exploração de quais seriam as orientação do tipo *Outras Orientações* que teve grande número de ocorrência e a investigação do por que o ano de 2016 reuniu maiores números de publicações e orientações.
